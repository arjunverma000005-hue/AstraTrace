...
-- 7. Analyst Reviews Table (Milestone 8 Human-in-the-Loop Decision Persistence)
...
-- 8. Comments for STAC, Embedding & Review Compatibility
...
COMMENT ON TABLE analyst_reviews IS 'AstraTrace auditable human-in-the-loop analyst decisions with evidence snapshots and provenance.';
